                        ...
                        <table className="items-center w-full bg-transparent border-collapse">
                            <thead className='border-b-2 border-black w-full p-10'>
                                ...
                                <th className='px-6 align-middle py-3 text-sm uppercase whitespace-nowrap font-semibold text-left'>S.No</th>
                                    <th className='px-6 align-middle py-3 text-sm capitalize whitespace-nowrap font-semibold text-left'>User ID</th>
                            ...
                            <tbody >
                                {
                                    customers.map((customer: any, index: any) => (
                                        <tr key={index} className='border-b-2'>
                                            ...
                                            <td className='px-6 align-middle font-medium text-sm p-4 text-left '>{customer._id}</td>
